...
export const stateCoordinates = {
  ...
  "Akwa Ibom": [5.0196, 7.9147],
  "Anambra": [6.2109, 7.0670],
  "Bauchi": [10.3158, 9.8442],
  "Bayelsa": [4.7725, 6.0640],
  "Benue": [7.3333, 8.7000],
  ...
  "Imo": [5.5000, 7.0333],
  "Jigawa": [12.1871, 9.3435],
  "Kaduna": [10.5105, 7.4165],
  "Kano": [12.0022, 8.5919],
  "Katsina": [12.9855, 7.6171],
  "Kebbi": [11.5000, 4.0000],
  "Kogi": [7.7337, 6.6906],
  "Kwara": [8.5000, 5.0000],
  "Lagos": [6.5244, 3.3792],
  "Nasarawa": [8.5000, 8.1667],
  "Niger": [9.9309, 5.5983],
  "Ogun": [7.1604, 3.3483],
  "Ondo": [7.1000, 5.0500],
  "Osun": [7.5000, 4.5833],
  "Oyo": [7.8430, 3.9314],
  "Plateau": [9.2633, 9.5175],
  "Rivers": [4.8156, 7.0498],
  "Sokoto": [13.0622, 5.2339],
  "Taraba": [8.0000, 10.5000],
  "Yobe": [12.0000, 11.5000],
  "Zamfara": [12.1700, 6.2000],
